...
Открытыми остаются два пункта: SourceRef внутри данных (бандл, golden) линтер не сканирует, только frontmatter; в `lint-docs.test.ts` нет ID инварианта в имени теста.
