...
**Версия пакета:** 0.16.0 · 09.09.2026  
**Статус:** DEV-01…10 сделаны. S-1…S-8, S-10, `glt lint docs`, `glt lint authority`, `glt compile registry`, `glt verify`, `glt validate`, `glt resolve`, `glt compile snapshot` и `glt impact` в CI; S-9 — предупреждение  
