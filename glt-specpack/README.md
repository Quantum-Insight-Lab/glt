...
**Версия пакета:** 0.11.0 · 08.09.2026  
**Статус:** DEV-01…04 сделаны. DEV-05: `glt lint authority` (INV-01) в CI, приёмка за человеком. S-1…S-8, S-10, `glt lint docs`, `glt verify` и `glt validate` в CI; S-9 — предупреждение  
