...
**Версия пакета:** 0.20.0 · 10.09.2026  
**Статус:** DEV-01…13 сделаны. DEV-14 в дереве. S-1…S-8, S-10, `glt lint docs`, `glt lint authority`, `glt compile registry`, `glt verify`, `glt validate`, `glt resolve`, `glt compile snapshot`, `glt impact`, seeded failures, correctness gate и collectors в CI; S-9 — предупреждение  
