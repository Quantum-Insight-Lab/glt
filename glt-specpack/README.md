...
**Статус:** DEV-01…14 сделаны. DEV-15 в дереве. S-1…S-8, S-10, `glt lint docs`, `glt lint authority`, `glt compile registry`, `glt verify`, `glt validate`, `glt resolve`, `glt compile snapshot`, `glt impact`, seeded failures, correctness gate и collectors в CI; S-9 — предупреждение  
