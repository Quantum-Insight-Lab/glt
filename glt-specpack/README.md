...
**Версия пакета:** 0.12.0 · 09.09.2026  
**Статус:** DEV-01…05 сделаны. DEV-06: `glt compile registry` в CI, приёмка за человеком. S-1…S-8, S-10, `glt lint docs`, `glt lint authority`, `glt verify` и `glt validate` в CI; S-9 — предупреждение  
