...
Статус: волна 4 закрыта. DEV-01…35 сделаны.
...
| Git collector | `collectGitFromRepo` факты, не политика | `packages/collectors/src/git.ts` |
...
| Sealed acceptance | `admitSealedRelease` | `packages/domain/src/seal.ts` |
